...
/**
 * Props for `KeyboardColorChanger`.
 */
export type KeyboardColorChangerProps =
  SliceComponentProps<Content.KeyboardColorChangerSlice>;

/**
 * Component for "KeyboardColorChanger" Slices.
 */
const KeyboardColorChanger: FC<KeyboardColorChangerProps> = ({ slice }) => {
...
export default KeyboardColorChanger;
